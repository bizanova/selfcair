...
import { DomainSelectorRootNodeParam } from "./domain_selector_root_node_param";
import { Component } from "@odoo/owl";
export class DomainSelectorParam extends Component {
    setup() {
        this.nextNodeId = 0;
    }
    buildTree() {
...
Object.assign(DomainSelectorParam, {
    template: "reports_designer._DomainSelectorParam",
    components: {
        DomainSelectorRootNodeParam,
    },
    props: {
        ...
        operatorParam: { type: String, optional: true },
        selectionParam: { type: Array, optional: true },
    },
    defaultProps: {
        readonly: true,
        update: () => {},
